function [mlpHog,labelLookup,accTrain,accTest,cMtrxTrain,cMtrxTest] = ...
    fct_train_HOG_MLP(mlpLayers, vecSizeHOG, imgsetTrain, imgsetTest)
% INM460: Computer Vision Coursework
% Heiko Maerz
%
% this function trains a HOG MLP classifier
% - input : MLP architecture: hidden layers and neurons
%           train dataset, test dataset, HOG feature vector size
...
clear testLabelLookup; clear testData; clear testLabels;
...
for i=1:size(imgsetTest,2)
    for j = 1:imgsetTest(i).Count
        ...
        testLabels{obsCount} = imgsetTrain(i).Description;
    end
end
